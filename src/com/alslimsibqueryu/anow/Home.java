...
public class Home extends TabActivity implements OnClickListener {
	...
	private void updateDatesDisplayed(int current) {
		...
		calendar.setAdapter(new DateAdapter(this, dates, tvCurMonth.getText()
				.toString(), this.eventsList, username));
		calendar.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View v, int pos,
				...
				// Toast.LENGTH_SHORT).show();
				tvDate.setText(((TextView) v.findViewById(R.id.tvDateCell))
						.getText() + " " + tvCurMonth.getText());
			}
		});
	}
